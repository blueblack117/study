 ...
 *
 */
public class Picture_Permute_Solution {

    public static void main(String[] args) {
        String[] condition = new String[] {"N~F=0", "R~T>2"};
        System.out.println(Picture_Permute_Solution.solution(2, condition));

        String[] condition2 = new String[] {"M~C<2", "C~M>1"};
        System.out.println(Picture_Permute_Solution.solution(2, condition2));
    }
